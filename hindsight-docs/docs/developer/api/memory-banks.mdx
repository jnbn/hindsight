...
<Tabs>
<TabItem value="python" label="Python">
<CodeSnippet code={memoryBanksPy} section="prompts-preview" language="python" />
</TabItem>
<TabItem value="node" label="Node.js">
<CodeSnippet code={memoryBanksMjs} section="prompts-preview" language="javascript" />
</TabItem>
<TabItem value="cli" label="CLI">
<CodeSnippet code={memoryBanksSh} section="prompts-preview" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
<CodeSnippet code={memoryBanksGo} section="prompts-preview" language="go" />
</TabItem>
</Tabs>
...
:::tip
[Dry-run extraction](/developer/api/memories) is the paid counterpart: it spends a real LLM call to show what the same configuration actually *extracts*. It resolves its config the same way, strategy included, so the two agree. The Control Plane pairs them in one prompt tester.
:::
...
<Tabs>
<TabItem value="python" label="Python">
<CodeSnippet code={memoryBanksPy} section="transfer-export" language="python" />
</TabItem>
<TabItem value="node" label="Node.js">
<CodeSnippet code={memoryBanksMjs} section="transfer-export" language="javascript" />
</TabItem>
<TabItem value="cli" label="CLI">
<CodeSnippet code={memoryBanksSh} section="transfer-export" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
<CodeSnippet code={memoryBanksGo} section="transfer-export" language="go" />
</TabItem>
</Tabs>
...
<Tabs>
<TabItem value="python" label="Python">
<CodeSnippet code={memoryBanksPy} section="transfer-import" language="python" />
</TabItem>
<TabItem value="node" label="Node.js">
<CodeSnippet code={memoryBanksMjs} section="transfer-import" language="javascript" />
</TabItem>
<TabItem value="cli" label="CLI">
<CodeSnippet code={memoryBanksSh} section="transfer-import" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
<CodeSnippet code={memoryBanksGo} section="transfer-import" language="go" />
</TabItem>
</Tabs>
...
<Tabs>
<TabItem value="python" label="Python">
<CodeSnippet code={memoryBanksPy} section="transfer-import-external" language="python" />
</TabItem>
<TabItem value="cli" label="CLI">
<CodeSnippet code={memoryBanksSh} section="transfer-import-external" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
<CodeSnippet code={memoryBanksGo} section="transfer-import-external" language="go" />
</TabItem>
</Tabs>
...
<Tabs>
<TabItem value="python" label="Python">
<CodeSnippet code={memoryBanksPy} section="clone-bank" language="python" />
</TabItem>
<TabItem value="node" label="Node.js">
<CodeSnippet code={memoryBanksMjs} section="clone-bank" language="javascript" />
</TabItem>
<TabItem value="cli" label="CLI">
<CodeSnippet code={memoryBanksSh} section="clone-bank" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
<CodeSnippet code={memoryBanksGo} section="clone-bank" language="go" />
</TabItem>
</Tabs>
...
:::warning A clone inherits the source's webhooks
...
<Tabs>
<TabItem value="python" label="Python">
<CodeSnippet code={memoryBanksPy} section="document-export" language="python" />
</TabItem>
<TabItem value="node" label="Node.js">
<CodeSnippet code={memoryBanksMjs} section="document-export" language="javascript" />
</TabItem>
<TabItem value="cli" label="CLI">
<CodeSnippet code={memoryBanksSh} section="document-export" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
<CodeSnippet code={memoryBanksGo} section="document-export" language="go" />
</TabItem>
</Tabs>
...
:::note The synchronous `GET …/document-transfer` was removed
...
<Tabs>
<TabItem value="python" label="Python">
<CodeSnippet code={memoryBanksPy} section="document-import" language="python" />
</TabItem>
<TabItem value="node" label="Node.js">
<CodeSnippet code={memoryBanksMjs} section="document-import" language="javascript" />
</TabItem>
<TabItem value="cli" label="CLI">
<CodeSnippet code={memoryBanksSh} section="document-import" language="bash" />
</TabItem>
<TabItem value="go" label="Go">
<CodeSnippet code={memoryBanksGo} section="document-import" language="go" />
</TabItem>
</Tabs>
